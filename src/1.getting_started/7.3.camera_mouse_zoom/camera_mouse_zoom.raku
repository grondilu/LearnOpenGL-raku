...
constant $vertex-shader-source   = "7.3.camera.vs".IO.slurp;
constant $fragment-shader-source = "7.3.camera.fs".IO.slurp;
...
sub MAIN {
  ...
  if GLFW::init() {
    ...
    my Real ($pitch, $yaw) = 0, -90°;
    GLFW::setCursorPosCallback
      $window,
      sub ($w, $xpos, $ypos) {
	constant $sensitivity = .001;
